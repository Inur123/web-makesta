                    ...
                    <div className="rounded-xl border bg-card p-6 shadow-sm">
                        ...
                        <dl className="space-y-4 text-sm">
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <dd className="col-span-2 font-semibold">{peserta.nama}</dd>
                            </div>
                            <div className="grid grid-cols-3 gap-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                ...
                                <dd className="col-span-2">{peserta.alamat || '-'}</dd>
                            </div>
                            <div className="grid grid-cols-3 gap-4">
                                <dt className="text-muted-foreground font-medium">No. HP / WA</dt>
                                <dd className="col-span-2">{peserta.no_hp || '-'}</dd>
                            </div>
                            <div className="grid grid-cols-3 gap-4">
                                <dt className="text-muted-foreground font-medium">Asal Sekolah</dt>
                                <dd className="col-span-2">{peserta.sekolah || '-'}</dd>
                            </div>
                        </dl>
                    </div>
                                ...
                                {materiList.map((m: Materi) => {
                                    ...
                                    return (
                                        <div key={m.id} className="flex items-center justify-between p-3 rounded-lg border bg-muted/20">
                                            <span className="font-medium text-sm">{m.nama}</span>

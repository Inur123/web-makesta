...
* @see app/Http/Controllers/KegiatanController.php:46
...
* @see app/Http/Controllers/KegiatanController.php:89
...
* @see app/Http/Controllers/KegiatanController.php:165
...
* @see app/Http/Controllers/KegiatanController.php:171
...
export const generateSertifikat = (args: { org: string | number, kegiatan: string | { id: string } } | [org: string | number, kegiatan: string | { id: string } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: generateSertifikat.url(args, options),
    method: 'post',
})

generateSertifikat.definition = {
    methods: ["post"],
...
generateSertifikat.url = (args: { org: string | number, kegiatan: string | { id: string } } | [org: string | number, kegiatan: string | { id: string } ], options?: RouteQueryOptions) => {
    ...
    return generateSertifikat.definition.url
            .replace('{org}', parsedArgs.org.toString())
            .replace('{kegiatan}', parsedArgs.kegiatan.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
const generateSertifikatForm = (args: { org: string | number, kegiatan: string | { id: string } } | [org: string | number, kegiatan: string | { id: string } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: generateSertifikat.url(args, options),
    method: 'post',
})
...
* @see app/Http/Controllers/KegiatanController.php:104
...
* @see app/Http/Controllers/KegiatanController.php:114
* @route '/{org}/kegiatan/{kegiatan}'
*/
...
* @see app/Http/Controllers/KegiatanController.php:150
* @route '/{org}/kegiatan/{kegiatan}'
*/
...
* @see app/Http/Controllers/KegiatanController.php:156
